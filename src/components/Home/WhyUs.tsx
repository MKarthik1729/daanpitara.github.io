...
{features.map((feature, index) => (
  ...
  >
    {/* Icon Section */}
    {/* Mobile: text-teal-500 (to match image green), smaller wrapper */}
    {/* Desktop: original margin bottom */}
    ...
    <div className="hidden md:flex w-34 h-[40px] justify-center items-center bg-[#86D1F7] rounded-lg mt-4">
